...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 38, fontWeight: '900', color: '#FFFFFF', marginBottom: 4, letterSpacing: -1 },
  ...
  cloudText: { fontSize: 9, fontWeight: '800', color: '#FF6B00', letterSpacing: 0.8 },
  scroll: { flex: 1 },
  scrollContent: { padding: 16, paddingBottom: 24 },
  empty: { alignItems: 'center', paddingTop: 96, gap: 18 },
  emptyTitle: { fontSize: 22, fontWeight: '700', color: '#FFFFFF' },
  emptyText: { fontSize: 15, color: '#999999', textAlign: 'center', lineHeight: 22, paddingHorizontal: 24 },
  card: {
  ...
  exName: { fontSize: 17, fontWeight: '700', color: '#FFFFFF', flex: 1 },
  trendBadge: { padding: 6, borderRadius: 8 },
  deleteBtn: { padding: 4 },
  statsGrid: { flexDirection: 'row', gap: 8, marginBottom: 14 },
  statCell: { flex: 1, backgroundColor: '#1A1A1A', borderRadius: 14, paddingVertical: 12, alignItems: 'center' },
  statVal: { fontSize: 20, fontWeight: '900', color: '#FF6B00', marginBottom: 2 },
  statKey: { fontSize: 8, fontWeight: '700', color: '#484848', letterSpacing: 0.5, textAlign: 'center' },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingTop: 4 },
  lastText: { color: '#999999', fontSize: 13 },
  dateText: { color: '#484848', fontSize: 12 },
});
...
const chartStyles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 11, fontWeight: '800', color: '#484848', letterSpacing: 1.5 },
  pctBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 14 },
  ...
  barLbl: { fontSize: 7, fontWeight: '800', color: '#484848', letterSpacing: 0.5 },
  statsRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  statBox: { gap: 2 },
  statLbl: { fontSize: 9, fontWeight: '700', color: '#484848', letterSpacing: 1 },
